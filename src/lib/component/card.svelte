...
<div class="mb-4 border-solid border-2 rounded-xl w-[90%] flex flex-col items-center hover:drop-shadow-lg transition-all hover:bg-[#F0F0F0] border-[#F0F0F0] hover:scale-105  duration-600">
